...
public class XlsToCsv {
    ...
    public void convertExcelToCSV(String strSource, String strDestination)
        ...
        this.convertExcelToCSV(strSource, strDestination,
                XlsToCsv.DEFAULT_SEPARATOR, XlsToCsv.EXCEL_STYLE_ESCAPING);
    }
    ...
    public void convertExcelToCSV(String strSource, String strDestination,
        ...
        // conventions
        this.convertExcelToCSV(strSource, strDestination,
                separator, XlsToCsv.EXCEL_STYLE_ESCAPING);
    }
    ...
    public void convertExcelToCSV(String strSource, String strDestination,
        ...
        // within range.
        if(formattingConvention != XlsToCsv.EXCEL_STYLE_ESCAPING &&
           formattingConvention != XlsToCsv.UNIX_STYLE_ESCAPING) {
