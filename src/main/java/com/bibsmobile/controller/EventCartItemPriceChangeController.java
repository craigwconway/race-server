...
public class EventCartItemPriceChangeController {
    ...
    /**
     * @api {post} /eventitemspricechanges/jsonArraySmart Smart Modify Price Changes
     * @apiName Smart Modify
     * @apiGroup pricechanges
     * @apiDescription Pass up an object of price changes mapped to a single event cart item containing only start dates,
     * prices, category names and mapped item, and the date ranges will be autogenerated.
     * @apiParam {Object} eventCartItem mapped eventCartItem object. this must be shared by all objects
     * @apiParam {Number} eventCartItem.id Id of mapped eventCartItem object used to locate it
     * @apiParam {String} categoryName Name of price change category
     * @apiParam {Number} price value to set price to
     * @apiParam {String} dateStartLocal String of date formatted as MM/dd/yyyy hh:mm:ss a
     * @apiParamExample {json} Sample Price Change Array
     * [
     * 	{
     * 		"eventCartItem":
     * 		{
     ...
     * 		},
     * 		"categoryName":"gramps",
     * 		"dateStartLocal":"10/14/2015 12:00:00 am",
     * 		"price":15
     * 	},
     * 	{
     * 		"eventCartItem":
     ...
     * 		},
     * 		"categoryName":"gramps",
     * 		"dateStartLocal":"10/15/2015 12:00:00 am",
     * 		"price":16
     * 	},
     * 	{
     * 		"eventCartItem":
     ...
     * 		},
     * 		"categoryName":"gramps",
     * 		"dateStartLocal":"10/22/2015 12:00:00 am",
     * 		"price":17
     * 	}
     * ]
     * 
    ...
    public ResponseEntity<String> createSmartFromJsonArray(@RequestBody String json) {
        ...
        for(EventCartItemPriceChange ecipc : EventCartItemPriceChange.findEventCartItemPriceChangesByEventCartItem(EventCartItem.findEventCartItem(eciId)).getResultList()) {
        	ecipc.setEventCartItem(null);
        	ecipc.merge();
        }
