...
privileged aspect UserGroupController_Roo_Controller {
    ...
    public String UserGroupController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String UserGroupController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, UserGroup.findUserGroup(id));
        return "usergroups/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String UserGroupController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
