 ...
 * a custom mapping might be for a beer run with the resulting object (in json form): {"field":"beers","result":"3"}
...
public class CustomResultField {
	...
	/**
	 * @return The value set by the mapping. An example of a response might be "3" for number of
	...
	/**
	 * @param result The value set by the mapping. An example of a response might be "3" for number of
	 * beers consumed at a beer run.
	 */
