...
public class PictureType {
	...
	public static PictureType fromJsonToPictureType(String json) {
        return new JSONDeserializer<PictureType>()
        .use(null, PictureType.class).deserialize(json);
    }
	...
	public static Collection<PictureType> fromJsonArrayToPictureTypes(String json) {
        return new JSONDeserializer<List<PictureType>>()
        .use("values", PictureType.class).deserialize(json);
    }
