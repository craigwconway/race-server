...
public class EventResult {
    ...
    public static EventResult fromJsonToEventResult(String json) {
        return new JSONDeserializer<EventResult>().use(null, EventResult.class).deserialize(json);
    }
    ...
    public static Collection<EventResult> fromJsonArrayToEventResults(String json) {
        return new JSONDeserializer<List<EventResult>>().use("values", EventResult.class).deserialize(json);
    }
    ...
    public static Long countFindEventResultsByEvent(Event event) {
        ...
        TypedQuery<Long> q = em.createQuery("SELECT COUNT(o) FROM EventResult AS o WHERE o.event = :event", Long.class);
