...
public class TimerConfig {
    ...
    public int hashCode() {
        ...
        result = prime * result + this.readPower;
        result = prime * result + this.type;
        result = prime * result + ((this.url == null) ? 0 : this.url.hashCode());
        result = prime * result + this.writePower;
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.ports == null) {
            ...
            return false;
        if (this.readPower != other.readPower)
            return false;
    ...
    public static Collection<TimerConfig> fromJsonArrayToTimerConfigs(String json) {
        return new JSONDeserializer<List<TimerConfig>>().use("values", TimerConfig.class).deserialize(json);
    }
